...
class SalesPersonRegistration extends StatelessWidget {
        ...
        child: Form(
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 20.0),
              const SizedBox(height: 20.0, child: Text('Full Address:', style: TextStyle(
                      color: Color(0xff090a0a),
                      fontSize: 16,
                      fontFamily: "Inter",
                      fontWeight: FontWeight.w500,
              ...
              TextFormField(
                decoration:
                    textInputDecoration.copyWith(hintText: 'city, state'),
                onChanged: (val) {},
              ),
              TextFormField(
